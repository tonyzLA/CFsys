...
AS 
select TOP 100 PERCENT skuprt.partno, orders.rollupitemQuantity, ship.totalWeight, postship.packagingtype, postship.DimsLength, postship.DimsWidth, postship.DimsHeight, MAX(ProcessedDate) ProcessDate
